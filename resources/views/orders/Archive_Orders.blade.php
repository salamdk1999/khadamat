                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'style="text-align: center">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-20p border-bottom-0"> استعادة الطلب</th>
                                    <th class="wd-20p border-bottom-0"> حذف الطلب نهائياً</th>
                                       ...
                                       <td>{{ $order->order_number }} </td>
                                        ...
                                        <td>
                                            <a class="btn btn-outline-info btn-sm"  data-order_id="{{ $order->id }}"
                                                data-toggle="modal" data-target="#Transfer_order"> إستعادة الطلب
                                            </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-outline-danger btn-sm" data-order_id="{{ $order->id }}"
                                                data-toggle="modal" data-target="#delete_order">حذف الطلب
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
