                    ...
                    <form action="{{ url('orders/update') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="order_number"
                                    title="يرجي ادخال رقم الطلب" value="{{ $orders->order_number }}" readonly required>
                            </div>

                            <div class="col">
                                <label>تاريخ الطلب</label>
                                <input class="form-control fc-datepicker" name="order_Date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $orders->order_Date }}" readonly required>
                            </div>

                            <div class="col">
                                <label>تاريخ الإستلام</label>
                                <input class="form-control fc-datepicker" name="Due_Date" placeholder="YYYY-MM-DD"
                                    type="text" value="{{ $orders->Due_Date }}" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Amount_collection"
                                    ...
                                    value="{{ $orders->Amount_collection }}">  
                            </div>
                        </div>
                        {{-- 3 --}}
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="3">{{ $orders->note }}</textarea>
                            </div>
                        </div><br>
